...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6755/ueventd.mt6755.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
else
  MTK_TARGET_VENDOR_RC = root
  PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.vendor.rc=/
  PRODUCT_COPY_FILES += device/mediatek/mt6755/ueventd.mt6755.rc:root/ueventd.mt6755.rc
endif

ifeq (yes,$(strip $(MTK_GMO_RAM_OPTIMIZE)))
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
endif

# media_profiles.xml for media profile support
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
...
PRODUCT_PACKAGES += gralloc.mt6755.so
...
PRODUCT_PACKAGES += radvd_chiptest.conf
...
ifeq ($(strip $(MTK_REBOOT_META_SUPPORT)),yes)
  ...
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/hardware/meta/misc/wifion/meta_connect_wifi.sh:system/etc/wifi/meta_connect_wifi.sh
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/hardware/meta/misc/wifion/meta_wpa_supplicant.conf:system/etc/wifi/meta_wpa_supplicant.conf
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/hardware/meta/misc/wifion/meta_poll_disconnect_wifi.sh:system/etc/wifi/meta_poll_disconnect_wifi.sh
else
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.mt6755.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6755.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/factory_init.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.modem.rc:$(MTK_TARGET_VENDOR_RC)/init.modem.rc

ifeq ($(strip $(MTK_C2K_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.c2k.rc:$(MTK_TARGET_VENDOR_RC)/init.c2k.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.c2k.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.c2k.rc
endif

ifeq ($(strip $(MTK_SENSORS_1_0)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.sensor_1_0.rc:$(MTK_TARGET_VENDOR_RC)/init.sensor_1_0.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.modem.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/meta_init.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.mt6755.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.mt6755.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/init.recovery.mt6755.rc:recovery/root/init.recovery.mt6755.rc
PRODUCT_COPY_FILES += device/mediatek/mt6755/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
else
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6755.nand:root/fstab.mt6755
endif
...
ifneq ($(filter yes,$(MTK_PUMP_EXPRESS_PLUS_SUPPORT) $(MTK_PUMP_EXPRESS_PLUS_20_SUPPORT) $(MTK_PUMP_EXPRESS_PLUS_30_SUPPORT)),)
  ...
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.wfd.6755.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_00:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.pip.6755.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_01:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.fdvrgis.6755.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_02:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.meta.6755.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_meta.conf:mtk
else
  ifeq ($(TARGET_BUILD_VARIANT),eng)
  ...
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.wfd.6755_noBCCT.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_00:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.pip.6755_noBCCT.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_01:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.fdvrgis.6755_noBCCT.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_02:mtk
  PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.meta.6755_noBCCT.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_meta.conf:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_audio_tablet.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_audio_basic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
endif

ifeq (yes,$(strip $(MTK_BSP_PACKAGE)))
    ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video_bsp_svp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
        PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core_bsp_svp.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video_bsp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
        PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core_bsp.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
     endif
else
    ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video_svp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
        PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core_svp.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_mediatek_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
        PRODUCT_COPY_FILES += device/mediatek/mt6755/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
    endif
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6755/media_codecs_google_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video_le.xml
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6755/audio_device.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device.xml:mtk
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt6755/audio_param
    ...
    else ifeq ($(strip $(MTK_TC10_FEATURE)),yes)
      AUDIO_PARAM_OPTIONS_LIST += SPH_PARAM_VERSION=1
    else
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.mediatek.platform=MT6755
PRODUCT_PROPERTY_OVERRIDES += ro.vendor.mediatek.platform=MT6755
...
#inherit prebuilt
$(call inherit-product-if-exists, vendor/mediatek/mt6755/device-vendor.mk)
